...
class Guest extends \Codeception\AbstractGuy
{
    ...
    * Conditional Assertion: Test won't be stopped on fail
     ...
     * @see Codeception\Module\WebHelper::amAdmin()
     * @return \Codeception\Maybe
     */
    public function amAdmin() {
        $this->scenario->addStep(new \Codeception\Step\Condition('amAdmin', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\WebHelper::amAdminWithMock()
     * @return \Codeception\Maybe
     */
    public function amAdminWithMock() {
        $this->scenario->addStep(new \Codeception\Step\Condition('amAdminWithMock', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     * 
     * @param Post $post
     * @see Codeception\Module\WebHelper::amOnPostPage()
     * @return \Codeception\Maybe
     */
    public function amOnPostPage($post) {
        $this->scenario->addStep(new \Codeception\Step\Condition('amOnPostPage', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
     *
     * @see Codeception\Module\WebHelper::prepareEmptyCache()
     * @return \Codeception\Maybe
     */
    public function prepareEmptyCache() {
        $this->scenario->addStep(new \Codeception\Step\Action('prepareEmptyCache', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
    * Conditional Assertion: Test won't be stopped on fail
     * @see Codeception\Module\WebHelper::seeEmptyCacheDir()
     * @return \Codeception\Maybe
     */
    public function canSeeEmptyCacheDir($debug = null) {
        $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('seeEmptyCacheDir', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     * @return \Codeception\Maybe
     */
    public function seeEmptyCacheDir($debug = null) {
        $this->scenario->addStep(new \Codeception\Step\Assertion('seeEmptyCacheDir', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
    * Conditional Assertion: Test won't be stopped on fail
     * @see Codeception\Module\WebHelper::seeNewCache()
     * @return \Codeception\Maybe
     */
    public function canSeeNewCache() {
        $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('seeNewCache', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function seeNewCache() {
        $this->scenario->addStep(new \Codeception\Step\Assertion('seeNewCache', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
     ...
     *
    * Conditional Assertion: Test won't be stopped on fail
     * @see Codeception\Module\WebHelper::seeCacheCommentTag()
     * @return \Codeception\Maybe
     */
    public function canSeeCacheCommentTag() {
        $this->scenario->addStep(new \Codeception\Step\ConditionalAssertion('seeCacheCommentTag', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
    ...
    public function seeCacheCommentTag() {
        $this->scenario->addStep(new \Codeception\Step\Assertion('seeCacheCommentTag', func_get_args()));
        if ($this->scenario->running()) {
            $result = $this->scenario->runStep();
            return new Maybe($result);
        }
