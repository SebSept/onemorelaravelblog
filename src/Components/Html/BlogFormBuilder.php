...
class BlogFormBuilder extends FormBuilder
{
    ...
    /**
     * provides Form::tagsSelector in blade templates
     * 
    ...
    /**
     * Provides Form::myInput in blade templates
     * 
     ...
     * @return string
     */
    public function myInput($attribute, $type, $label)
    {
        $return = '';

        $return .= '<div class="form-group">';
        $return .= self::label($attribute, $label, ['class' => 'col-sm-2 control-label', 'for' => $attribute]);
        $return .= '<div class="col-sm-10">';
